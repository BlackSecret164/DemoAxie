...
import { MockBuyModal } from "@/components/mock-buy-modal"
...
interface MockAxieCardProps {
  creature: Creature
}

export function MockAxieCard({ creature }: MockAxieCardProps) {
  ...
  return (
    <>
      ...
      <MockBuyModal isOpen={showBuyModal} onClose={() => setShowBuyModal(false)} creature={creature} />
    </>
  )
}